...
- *Contacts* area contains text fields on *Name and email of contact person for the protocols*.  
- *Technique and Endpoints* area is different for each of the protocol types: 
